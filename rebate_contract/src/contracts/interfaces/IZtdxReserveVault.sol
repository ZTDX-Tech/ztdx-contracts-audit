...
interface IZtdxReserveVault {
    ...
    /// @notice Get the USDT balance of a user
    /// @param user The address of the user
    /// @return The USDT balance (in USDT decimals)
    function accountLiquidity(address user) external view returns (uint256);

    /// @notice Batch get USDT accountLedgers for multiple users
    /// @param users Array of user addresses
    /// @return Array of accountLedgers (in USDT decimals)
    ...
    /// @notice User USDT accountLedgers
